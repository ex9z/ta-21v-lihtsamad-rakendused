...
def next_pos_true(current_posY, current_posX):
    ...
    if rand == 1:
        go_right = current_posX+1 < x_collumn and map [current_posY][current_posX+1] == 1 or current_posX+1 < x_collumn and map [current_posY][current_posX+1] == 24
    else:
        go_right = False
    
    if rand == 2:
        go_left = current_posX-1 >= 0 and map [current_posY][current_posX-1] == 1 or current_posX-1 >= 0 and map [current_posY][current_posX-1] == 24
    else:
        go_left = False
    
    if rand == 3:
        go_down = current_posY+1 < y_row and map [current_posY+1][current_posX] == 1 or current_posY+1 < y_row and map [current_posY+1][current_posX] == 24
    else:
        go_down = False
    
    if rand == 4:
        go_up = current_posY-1 >= 0 and map [current_posY-1][current_posX] == 1 or current_posY-1 >= 0 and map [current_posY-1][current_posX] == 24
    else:
        go_up = False
